    ...
    public class TicketAttachmentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "TicketId")] TicketAttachment ticketAttachment, string attachmentTitle, string attachmentDescription, HttpPostedFileBase FilePath)
        {
            if (ModelState.IsValid)
            {
                ...
                if (ImageHelpers.IsValidAttachment(FilePath))
                {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,TicketId,Title,UserId,Description,FilePath,Created")] TicketAttachment ticketAttachment)
        {
            if (ModelState.IsValid)
            {
